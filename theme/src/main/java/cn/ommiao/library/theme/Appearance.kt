...
import cn.ommiao.library.theme.foundation.ColorPalette
import cn.ommiao.library.theme.foundation.Radius
...
@Composable
fun ComponentActivity.EdgeToEdgeEffect(theme: Appearance.Theme) {
